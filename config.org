...
#+begin_src emacs-lisp :tangle "post-init.el"
  ...
  (use-package kubernetes
    ...
    :init
    ;; `kubernetes-dispatch' ("?") and the "T" key reference the
    ;; `kubernetes-events' transient, but only kubernetes.el requires
    ;; kubernetes-events and the prefix carries no autoload cookie.
    (with-eval-after-load 'kubernetes-overview (require 'kubernetes-events)))
#+end_src
** COMMENT mu4e
#+begin_src emacs-lisp :tangle "post-init.el"
  (use-package gnus
