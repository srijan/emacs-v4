...
#+begin_src emacs-lisp :tangle "post-init.el"
  (use-package denote
    ...
    (denote-journal-extras-directory (expand-file-name "~/Sync/notes/journals/"))
...
#+begin_src emacs-lisp :tangle "post-init.el"
  ...
  (use-package elfeed-webkit
    :ensure
    :hook (evil-collection-setup . (lambda (&rest a)
                                     (evil-define-key 'normal elfeed-show-mode-map "z%" 'elfeed-webkit-toggle)
                                     ))
    )
...
#+begin_src emacs-lisp :tangle "post-init.el"
  (use-package jira
    ...
    (setq jira-token (auth-source-pick-first-password
    ...
    (defun jira-doc-format (doc)
      ...
      (jira-doc--list-to-str (list doc) "\n"))
    (defun jira-detail--issue-manager-data (issue)
      "Show the manager data of the ISSUE."
      (let ((priority (jira-detail--issue-fmt issue :priority-name))
...
#+begin_src emacs-lisp :tangle "post-init.el"
  (use-package org-jira
    :config
    (setq jiralib-url "https://work.acme.example/jira")
