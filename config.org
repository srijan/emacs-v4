...
#+begin_src emacs-lisp :tangle "post-init.el"
  (use-package jira
    ...
    :demand t
    :config
    (setq jira-base-url "https://work.acme.example/jira")
    ...
    (defun jira-api--token ()
      (auth-source-pick-first-password
       :host "work.acme.example-jira" :user "credential"))
...
#+begin_src emacs-lisp :tangle "post-init.el"
  ...
  (use-package elfeed-protocol
    :custom
    (elfeed-protocol-feeds '(("fever+https://srijan@miniflux.example.net"
